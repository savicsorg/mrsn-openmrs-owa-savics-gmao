...
var getEquipmentStatusById = function (id, language) {
    var value = id;

    if (id && id !== "") {
        var found = _.findWhere(require('../../json/equipment/equipmentStatus.json'), {id: id});
        if (found) {
            if (language === "" || language === null || language === undefined) {
                value = found['en'];
            } else {
 ...
 */
var getEquipmentStatus = function (language) {
    var data = require('../../json/equipment/equipmentStatus.json');
